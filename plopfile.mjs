export default function (
  ...
  plop.setGenerator("docs", {
    ...
    prompts: [
      ...
      {
        type: "confirm",
        name: "generateDocFile",
        message: "Do you want to generate a doc file?",
      },
      {
        type: "confirm",
        name: "generateExampleFiles",
        message: "Do you want to generate example files?",
      },
      {
        type: "confirm",
        name: "registerExampleFiles",
        message: "Do you want to register the example files?",
      },
    ],
