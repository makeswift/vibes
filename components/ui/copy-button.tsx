  ...
  return (
    ...
    >
      ...
      <div className="relative h-4 w-4">
        ...
        <div className="absolute right-0 top-0 h-3 w-3 rounded border border-docs-foreground bg-docs-background transition-transform duration-150 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"></div>
      </div>
    </button>
  )
}
