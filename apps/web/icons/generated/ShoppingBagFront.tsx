...
const SvgShoppingBagFront = (props: SVGProps<SVGSVGElement>) => (
  <svg fill="none" height={234} width={210} xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
    ...
    <path
      ...
      fillRule="evenodd"
    />
    <path d="M178.324 61.2H55.351L75.027 217H198z" fill="url(#shopping-bag-front_svg__a)" />
    <path d="M45.514 61.2h119.693l3.28 155.8H29.117z" fill="#D79E42" />
    <path d="M168.487 194.04 138.973 217H198z" fill="#E4AA4D" />
    <path d="M32.397 61.2H152.09L138.973 217H16z" fill="url(#shopping-bag-front_svg__b)" />
    <defs>
      <linearGradient
