...
export function ShoppingBag() {
  return (
    <div className="absolute -bottom-28 left-1/3 z-10 hidden origin-top-left scale-110 sm:block md:-top-2 md:bottom-auto md:left-full md:scale-75 xl:scale-100">
      <Draggable>
        {({ active, hover }) => (
          <Transition
