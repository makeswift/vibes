...
export function HandcraftedCode() {
  return (
    <div className="absolute -right-8 -top-5 z-10 ml-4 origin-bottom-left scale-100 sm:top-20 md:-bottom-5 md:left-full md:right-auto md:top-auto md:scale-75 xl:scale-100">
      <Draggable>
        {({ active, hover }) => (
          <Transition
