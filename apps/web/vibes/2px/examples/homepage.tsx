      ...
      <MediaAndTextSection
        ...
        text={
          <p className="text-body font-medium leading-tight @2xl:text-2xl @2xl:-tracking-[0.01em]">
            We aim to provide artists with a platform to show off their one-of-a-kind and limited
            edition contemporary work in furniture, ceramics, sculpture, and design. The designers
            range from well-known names to emerging talents, each exhibiting a distinctive approach
            or style that is unequivocally unique in some manner. With the use of unique and special
            materials that can suit diverse interiors and styles, our curation attempts to reflect
            the diversity of artistic inspirations.
          </p>
        }
        links={[
