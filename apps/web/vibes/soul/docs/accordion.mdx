...
Refer to the Radix UI documentation for the [Accordion.Item](https://www.radix-ui.com/primitives/docs/components/accordion#item) component. In addition, this copmonent depends on these additional properties:
