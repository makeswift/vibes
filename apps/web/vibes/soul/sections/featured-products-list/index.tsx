...
export const FeaturedProductsListSkeleton = function FeaturedProductsListSkeleton() {
  return (
    <>
      <div>
        <div className="mb-4 h-[18px] w-20 animate-pulse rounded-lg bg-contrast-100 @4xl:h-16 @4xl:w-72" />
        <div className="h-8 w-64 animate-pulse rounded-lg bg-contrast-100" />
      </div>
      <div className="h-5 w-32 animate-pulse rounded-lg bg-contrast-100 @4xl:h-12 @4xl:rounded-full" />
    </>
  )
}
