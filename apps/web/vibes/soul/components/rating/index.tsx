...
export default function Rating({ rating }: Readonly<Props>) {
  ...
  return (
    <div className="flex">
      ...
      <span className="ml-1 flex h-5 min-w-5 shrink-0 items-center justify-center rounded-full border border-foreground px-1 text-xs font-medium text-contrast-300">
