...
export const Input = forwardRef(function Input(
  ...
  return (
    <div
      style={{
        background:
          variant === 'brand' ? getBrandShade(activeBrand?.name, 100) : 'var(--background)',
      }}
      className="relative w-full shrink-0 rounded-lg border border-contrast-100 font-medium transition-colors duration-200 focus-within:border-foreground focus:outline-none"
    >
      {variant === 'price' && (
