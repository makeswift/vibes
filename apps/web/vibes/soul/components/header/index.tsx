    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="ml-auto mr-1 flex items-center gap-0 transition-colors duration-300 @sm:mr-0 @4xl:mr-2.5">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                className="z-50 mt-4 max-h-80 w-20 overflow-y-scroll rounded-xl bg-background p-2 shadow-[2px_4px_24px_#00000010] 
                data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 
                data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 
                @4xl:-ml-14 @4xl:w-32 @4xl:rounded-3xl @4xl:p-4"
              >
        ...
        >
          ...
          {/* Search Results */}
          <div className="flex border-t border-contrast-100">
            <div className="flex w-full max-w-80 flex-col gap-1 border-r border-contrast-100 p-5">
          ...
          {/* View all items */}
          <div className="w-full border-t border-contrast-100 p-5">
            <Link
              href="/"
              className="group flex w-fit items-center gap-1 text-[15px] font-semibold"
            >
              View all items
