    ...
    <Dialog.Root open={isOpen} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-30 bg-foreground/50 @container">
          <Dialog.Content
            className={clsx(
              'fixed right-0 top-0 flex h-full max-h-dvh flex-col overflow-y-auto bg-background p-6 @md:p-20',
              ...
              'data-[state=closed]:slide-out-to-right-72 data-[state=open]:slide-in-from-right'
            )}
          >
            {content}
          </Dialog.Content>
