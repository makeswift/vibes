  ...
  return (
    ...
    >
      <div className="font-[family-name:var(--alert-font-family,var(--font-family-body))]">
        ...
        {Boolean(description) && (
          <div className="text-xs font-medium text-[var(--alert-description-text,hsl(var(--foreground)/50%))]">
            {description}
          </div>
        )}
      </div>
      <div className="flex items-center gap-1">
        {action && (
          <Button onClick={action.onClick} size="x-small" text={action.text} variant="ghost" />
        )}
        <Button
