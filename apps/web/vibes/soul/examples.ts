...
export const examples = [
  ...
  },
  {
    ...
    files: ['examples/sections/products-list/electric.tsx'],
    component: lazy(() => import('./examples/sections/products-list/electric')),
  },
  {
    name: 'products-list-warm',
    dependencies: [],
    registryDependencies: ['products-list-warm'],
    files: ['examples/sections/products-list/warm.tsx'],
    component: lazy(() => import('./examples/sections/products-list/warm')),
  },
  {
    name: 'products-list-luxury',
    dependencies: [],
    registryDependencies: ['products-list-luxury'],
    files: ['examples/sections/products-list/luxury.tsx'],
    component: lazy(() => import('./examples/sections/products-list/luxury')),
  },
  {
