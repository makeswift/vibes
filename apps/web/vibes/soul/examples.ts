...
export const examples = [
  ...
  },
  {
    ...
    files: ['examples/page-not-found-electric.tsx'],
    component: lazy(() => import('./examples/page-not-found-electric')),
  },
  {
    name: 'page-not-found-warm-example',
    dependencies: [],
    registryDependencies: ['page-not-found-warm'],
    files: ['examples/page-not-found-warm.tsx'],
    component: lazy(() => import('./examples/page-not-found-warm')),
  },
  {
    name: 'page-not-found-luxury-example',
    dependencies: [],
    registryDependencies: ['page-not-found-luxury'],
    files: ['examples/page-not-found-luxury.tsx'],
    component: lazy(() => import('./examples/page-not-found-luxury')),
  },
  {
