...
export const examples = [
  ...
  {
    name: 'category-card-carousel-electric',
    dependencies: [],
    registryDependencies: ['category-card-carousel-electric'],
    files: ['examples/sections/category-card-carousel/electric.tsx'],
    component: lazy(() => import('./examples/sections/category-card-carousel/electric')),
  },
  {
    name: 'category-card-carousel-warm',
    dependencies: [],
    registryDependencies: ['category-card-carousel-warm'],
    files: ['examples/sections/category-card-carousel/warm.tsx'],
    component: lazy(() => import('./examples/sections/category-card-carousel/warm')),
  },
  {
    name: 'category-card-carousel-luxury',
    dependencies: [],
    registryDependencies: ['category-card-carousel-luxury'],
    files: ['examples/sections/category-card-carousel/luxury.tsx'],
    component: lazy(() => import('./examples/sections/category-card-carousel/luxury')),
  },
  {
    name: 'category-card-example',
    dependencies: [],
    registryDependencies: ['category-card'],
    files: ['examples/primitives/category-card/index.tsx'],
    component: lazy(() => import('./examples/primitives/category-card')),
  },
  {
  ...
  {
    name: 'range-input-example',
    dependencies: [],
    registryDependencies: ['range-input'],
    files: ['examples/form/range-input/index.tsx'],
    component: lazy(() => import('./examples/form/range-input')),
  },
  {
    name: 'rating-example',
    dependencies: [],
  ...
  },
  {
    ...
    dependencies: [],
    registryDependencies: [],
    files: ['examples/sections/error/index.tsx'],
    component: lazy(() => import('./examples/sections/error')),
  },
  {
    name: 'label-example',
    dependencies: [],
    registryDependencies: [],
    files: ['examples/form/label/index.tsx'],
    component: lazy(() => import('./examples/form/label')),
  },
  {
  ...
  },
  {
    ...
    files: ['examples/primitives/tree/index.tsx'],
    component: lazy(() => import('./examples/primitives/tree')),
  },
  {
    name: 'reveal-example',
    dependencies: [],
