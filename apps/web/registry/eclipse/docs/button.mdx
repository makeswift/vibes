...
| ------------------------ | ------- | -------------------------------- |
| January                  | $250    | Prop                             |
| February                 | $80     | [`hello`](https://makeswift.com) |
| March asjhfkgasdj sadfas | $420    | `sup`                            |

<div className="pattern-shadow pattern-shadow-sm mb-5 mt-5 aspect-[4/3] border border-foreground bg-background">
  <iframe
