...
function Accordion({
  ...
  return (
    <AccordionRadix.Item
      className="group pointer-events-none border border-dashed border-contrast-300 bg-background transition-all hover:border-foreground data-[state=open]:border-solid"
      value={value}
    >
